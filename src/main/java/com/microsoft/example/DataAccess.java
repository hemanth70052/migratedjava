...
public class DataAccess
{
	...
	static {
		try {
			...
			String conStr = System.getenv("jdbc:mysql://sample-java.mysql.database.azure.com:3306/alm?useSSL=true&requireSSL=false&autoReconnect=true&user=sample&password=password@12345");
